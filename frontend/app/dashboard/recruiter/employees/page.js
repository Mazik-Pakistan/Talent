                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <div className={styles.avatarSm} style={{ width: 40, height: 40, flexShrink: 0 }}>
                        {employee.profileImage?.secure_url ? (
                          ...
                          initialsFor(employee.full_name)
                        )}
                      </div>
                      <div>
        ...
        <div className={styles.section}>
          <div className={styles.sectionHead}>
            <div className={styles.sectionHeadLeft}>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div className={styles.avatarSm} style={{ width: 44, height: 44, flexShrink: 0 }}>
                    {selectedEmployee.profileImage?.secure_url ? (
                      <img
                        src={selectedEmployee.profileImage.secure_url}
                        alt={selectedEmployee.full_name}
                        style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }}
                      />
                    ) : (
                      initialsFor(selectedEmployee.full_name)
                    )}
                  </div>
                  <div>
