...
async def create_department(request: dict, current_user: RequireRecruiterLearning):
...
async def update_department(name: str, request: dict, current_user: RequireRecruiterLearning):
...
async def delete_department(name: str, current_user: RequireRecruiterLearning):
...
async def create_role(request: dict, current_user: RequireRecruiterLearning):
...
async def update_role(role_id: str, request: dict, current_user: RequireRecruiterLearning):
...
async def delete_role(role_id: str, current_user: RequireRecruiterLearning):
...
async def create_skill(request: dict, current_user: RequireRecruiterLearning):
...
async def update_skill(skill_id: str, request: dict, current_user: RequireRecruiterLearning):
...
async def delete_skill(skill_id: str, current_user: RequireRecruiterLearning):
...
async def create_certification(request: dict, current_user: RequireRecruiterLearning):
...
async def update_certification(cert_id: str, request: dict, current_user: RequireRecruiterLearning):
...
async def delete_certification(cert_id: str, current_user: RequireRecruiterLearning):
...
async def create_course(request: dict, current_user: RequireRecruiterLearning):
...
async def update_course(course_id: str, request: dict, current_user: RequireRecruiterLearning):
...
async def delete_course(course_id: str, current_user: RequireRecruiterLearning):
...
async def create_roadmap(request: dict, current_user: RequireRecruiterLearning):
...
async def update_roadmap(roadmap_id: str, request: dict, current_user: RequireRecruiterLearning):
...
async def delete_roadmap(roadmap_id: str, current_user: RequireRecruiterLearning):
...
async def upsert_promotion_rule(request: dict, current_user: RequireRecruiterLearning):
...
async def delete_promotion_rule(role_name: str, current_user: RequireRecruiterLearning):
...
async def create_version(request: dict, current_user: RequireRecruiterLearning):
...
async def apply_import(request: dict, current_user: RequireRecruiterLearning):
