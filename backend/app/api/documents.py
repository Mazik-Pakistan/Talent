...
async def list_owner_documents(owner_id: str, current_user: RequireRecruiter, _capability: Annotated[CurrentUser, Depends(require_recruiter_capability("candidates"))]):
...
async def verify_document(document_id: str, payload: DocumentVerifyRequest, current_user: RequireRecruiter, _capability: Annotated[CurrentUser, Depends(require_recruiter_capability("candidates"))]):
